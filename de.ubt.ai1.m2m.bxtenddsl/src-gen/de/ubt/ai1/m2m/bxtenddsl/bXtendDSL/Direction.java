 ...
 * <!-- end-user-doc -->
 * @see de.ubt.ai1.m2m.bxtenddsl.bXtendDSL.BXtendDSLPackage#getDirection()
 * @model
 * @generated
 */
public enum Direction implements Enumerator
{
   ...
   * @ordered
   */
  public static final int FWD_VALUE = 0;

  /**
   * The '<em><b>BWD</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>BWD</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #BWD
   ...
   * @ordered
   */
  public static final int BWD_VALUE = 1;
   ...
   * @ordered
   */
  public static final int BX_VALUE = 2;
